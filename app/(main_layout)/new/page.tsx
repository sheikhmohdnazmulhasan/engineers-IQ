    ...
    return (
        <>
            ...
            {!isLoading && !currentUser && (
                <div className="inset-0 flex items-center min-h-screen -mt-28 justify-center">
                ...
                currentUser && currentUser?.isEmailVerified && !currentUser.isBlocked && (
                    <form className="space-y-4" onSubmit={handleSubmit(handleSave)}>
                        ...
                        <div className="h-[430px] ">
                            <ReactQuill className='h-96' formats={formats} modules={modules} theme="snow" value={content} onChange={handleChange} />
                        </div>

                        <div className="  my-10 mt-10">
                            {imagesLoaded ? (
                                <div className=" mx-auto border flex flex-wrap items-center gap-x-6 p-5 space-y-4">
